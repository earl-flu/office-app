...
const submit = () => {
  form.post(route("employee-activities.store"), {
    onSuccess: () => {
      const toast = useToast();
      toast.success("Employee Activity Created Successfully", {
        timeout: 3000,
      });
    },
  });
...
<template>
  <Head title="Create Employee Activity" />
      ...
      <div class="col-12 col-xl-8">
        <div class="card">
          <div class="card-body p-4">
            <h5 class="mb-4">Add Employee Activity Form</h5>
